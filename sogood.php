    ...
    <div id="content" class="clearfix">
    	...
    	<div class="row">
            <div class="col col_5 align_center">
            	<p><a href="npos.php" title="Check out the awesome nonprofits we work with!"><img src="images/social_good_icon.jpg" width="304" height="121" /></a></p>
            </div>
        	<div class="col col_8">
            	...
            	<p class="align_justify"><!--As the Internet evolves, it's reach increases and the world shrinks.  Today we can see what's happening, in real time, nearly anywhere on the planet.  As we rejoice in our technological revolution, we are at a crossroads where we can no longer stand in the shadow of blissful ignorance. -->Through technology pungle provides the opportunity to make a difference globally. Right now there are people without access to some very basic human needs: clean water, education, large scale disease prevention, agriculture and fundamental human rights. We accomplish this by working with next generation nonprofits that deliver tangible results.<br/><br/><a href="npos.php" title="Check out the awesome nonprofits we work with!">Check out the Nonprofits ></a></p></p>
        ...
        <div class="row">
            <div class="col col_5 align_center">
            	<p><a href="anvil.php" title="The Anvil beckons you."><img src="images/anvil_icon_lrg.png" width="199" height="200" /></a></p>
            </div>
        	<div class="col col_8">
