...
<?php require("include/nav.php"); ?>
    ...
    <div id="content" class="clearfix">
    	...
    	<div class="row">
            <div class="col col_13">
            	...
            	<p><strong>Philosophy:</strong> pungle is revolutionizing business by measuring our worth in social good. We don't answer to investors, stockholders, or venture firms; there are no equity payouts or high paid exectuives. Instead, we donate 100% of our profits towards our <a href="/social-good/cause-portfolio/" title="Check it out!">cause portfolio</a>. We're asking that you join our social good movement by making one small change in the the way you shop by using <a href="/anvil/" title="It start right here.">the anvil</a>. Then just sit back, relax and partake in our delectable culture.</p>
            	<p><strong>For-Profit vs Non-Profit:</strong> Since we donate 100% of our profits, we're a for-profit business; higher profits = higher donations. Specifically, it means we can invest more into the business, better service our customers, attract top talent employees and have a lot more flexibility. It also lets us challenge the idea of business, capitalism and responsiblities of companies in the 21st century.</p>
            	<p><strong>How it Works:</strong> pungle collects revenue by promoting vendors through our anvil shopping tool; at absolutely <strong>no expense</strong> to our community. Consider it a levy against companies that already pad their prices with a margin, we just reclaim it in the name of social good. Yes, this is a little bit like Robin Hood.<!-- Then we manage, invest and/or donate 100% of our profits towards the most tangible, progressive and effective causes. --></p>
        ...
        <div class="row">
        	...
        	<div class="col col_13">
        		<p><strong><em><a href="http://en.wikipedia.org/wiki/Wikipedia:Too_long;_didn't_read" target="_blank" title="Too long; didn't read. Gimme a one sentence summary.">TL;DR</a> intoxicated gamers founded pungle to make up for their wretched ways.</em></strong></p>
        	</div>
    ...
    <!-- Justin Hammack -->
		<div class="row">
			...
			<div class="col col_8">
				...
				<p>
					...
					<br/>
					Created pungle in October, 2010. However, in 2011 pungle burst from flames, reborn, with the help of the co-founders below. I'm an entrepreneur, vegetarian foodie, coffee addict, ex-pro PC gamer, lover of cult movies, and driver of insane turbo-2.0L. I'm based out of Seattle, where the pungle secrets are kept. Yes, I'd love to grab some happy hour, glad you asked.
				</p>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col col_8">
				...
				<p><em>Co-Founder. Director of propaganda. Puts the sass in sassy.</em><br/>
					<br/>
					I'm married to a wonderful woman and co-founder of a business that inspires me. I grew up playing the original Nintendo. My generation invented gaming, sorry, you can't top that. I have an elementary school degree in Oregon Trail. You know what, forget this, I can't be bothered to talk too much about myself, because frankly I'm busy being unbelievably awesome. What's that you say? How awesome am I? <a href="http://www.google.com/images?q=unicorns" target="_blank">THIS AWESOME</a>.
				</p>
			</div>
		</div>
		...
		<div class="row">
			<div class="col col_13">
				<small>pungle is based out of Seattle, WA (business license #603021592)</small>
			</div>
		</div>
