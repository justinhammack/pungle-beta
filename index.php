...
<?php require("include/nav.php"); ?>
	...
	<div id="content" class="clearfix">
	    ...
	    <div class="row">
	        ...
	        <div class="col indexForm">
	            ...
	            <!-- Begin MailChimp Signup Form -->
                    ...
                    var mc_custom_error_style = 'background: #FFEEEE none repeat scroll 0% 0%; float: left; z-index: 1; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; color: #FF0000;';
                    </script>
		...
		<!--<div class="col col_7 align_right indexMission">
    ...
    <script type="text/javascript">
        ...
        function mce_init_form(){
            jQuery(document).ready( function($) {
              ...
              options = { url: 'http://pungle.us2.list-manage1.com/subscribe/post-json?u=49a938eaff3e75d15622b305b&id=4705aa678e&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
